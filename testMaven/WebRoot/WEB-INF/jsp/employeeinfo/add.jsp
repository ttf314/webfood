...
<div class="panel admin-panel">
    <div class="panel-head" id="add">
        <strong><span class="icon-pencil-square-o">新增雇员</span> </strong>
    </div>
    <div class="body-content">
        <form action="${ctx}/employeeinfo/exAdd" method="post" class="form-x" enctype="multipart/form-data">
            <div class="form-group">
                <div class="label"><label>雇员名称：</label></div>
                <div class="field">
                    <input type="text" class="input w50" name="employeename" data-validate="required:请输入雇员名称" />
                    <div class="tips"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="phone" data-validate="required:请输入雇员手机号" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="address" data-validate="required:请输入雇员地址" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="rmb" data-validate="required:请输入雇员大概薪资" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
