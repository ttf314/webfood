...
<div class="panel admin-panel">
    <div class="padding border-bottom">
        <ul class="search" style="padding-left: 10px;">
            <li>
                <a class="button border-main icon-plus-square-o" href="${ctx}/itemCategory/add">新增商家</a>
            </li>
            <li>
                <a class="button border-main icon-plus-square-o" href="${ctx}/itemCategory/delete4">密码重置</a>
            </li>
        </ul>
    </div>
        ...
        <tr>
            ...
            <td>
                <div class="button-group">
                    <a class="button border-main" href="${ctx}/itemCategory/findBySql2?pid=${data.id}"><span class="icon-edit">查看该商家餐品分类</span> </a>
