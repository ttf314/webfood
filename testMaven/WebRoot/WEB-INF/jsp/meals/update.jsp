...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form action="${ctx}/meals/exUpdate" method="post" class="form-x" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="label"><label>大致商品数量：</label></div>
                <div class="field">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <div class="tips">
                        <img src="${obj.url1}" alt="${obj.url1}" style="width: 200px; height: 200px;">
                    </div>
                </div>
            </div>
