...
<div class="panel admin-panel">
    <form action="${ctx}/order/findBySql3" id="listform" method="post">
        <div class="padding border-bottom">
            <ul class="search" style="padding-left: 10px;">
                ...
                <li>
                    <a class="button border-main icon-plus-square-o" href="${ctx}/order/findBySql2">查看已交付的订单</a>
                </li>
            </ul>
        </div>
    </form>
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <tr>
                ...
                <td>${data.date2}</td>
                <td>
                    <a class="button border-red" href=""><span class="icon-trash-o">已删除</span> </a>
                </td>
