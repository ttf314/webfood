...
<div class="panel admin-panel">
    <form action="${ctx}/question/findBySql" id="listform" method="post">
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <tr>
                ...
                <td>${data.questionStatus}</td>
                <td>${data.whoneedanswer}</td>
                <td>${data.dianid}</td>
                <td>
                    <a class="button border-red" href="${ctx}/question/up?id=${data.id}"><span class="icon-trash-o">删除</span> </a>
                </td>
                <td>
                    <a class="button border-main" href="${ctx}/question/findBySql2?id=${data.id}"><span>查看回复</span> </a>
                </td>
            </tr>
        </c:forEach>
        <tr>
