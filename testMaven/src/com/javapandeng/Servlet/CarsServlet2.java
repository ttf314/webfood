 ...
 */
@WebServlet("/CarsServlet2")
public class CarsServlet2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String name=request.getParameter("carsString");
        System.out.println(name+"1");
        List<Cars> cars = new ArrayList<>();//数据集合
        CarDao carDao=new CarDao();//操作
        cars = carDao.getCarsByname(name);   // 获取搜索栏的食物数据
