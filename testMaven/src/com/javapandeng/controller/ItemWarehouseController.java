 ...
 */
@Controller
@RequestMapping("/Item_warehouse")
public class ItemWarehouseController extends BaseController {
    @Autowired
    ...
    public String tj2(Item_warehouse item_warehouse, Model model, HttpServletRequest request, HttpServletResponse response) {
...
//存储查询结果
       ...
       /* //分页查询
        String sql = "SELECT * FROM item_warehouse WHERE isDelete = 0 and pid ="+uid;
        sql += " ORDER BY ID DESC ";
        List<Item_warehouse> list = Item_warehouseService.listBySqlReturnEntity(sql);
        List<Map<String,Object>> maps = new ArrayList<Map<String,Object>>();
        List<Charts> res = new ArrayList<Charts>();
